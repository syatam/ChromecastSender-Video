package com.syatam.chromecastsender_video;
...
public class VideoActivity extends AppCompatActivity {
    ...
    private void startVideo() {
        ...
        mediaMetadata.putString( MediaMetadata.KEY_TITLE, getString( R.string.video_title ) + getString(R.string.content_type) );

        MediaInfo mediaInfo = new MediaInfo.Builder( getString( R.string.video_url ) )
                .setContentType( getString( R.string.content_type ) )
